...
const COURSE_IMAGE_MAPPING: Record<string, string> = {
    "aiforeveryone": "ai for everyone.jpg",
    "introductiontoai": "introduction to ai.jpg",
    "machinelearningspecialization": "machine learning specialization.jpg",
    "generativeaiforeveryone": "generative ai for everyone.jpg",
    "deeplearningspecialization": "deep learning specialization.jpg",
    "naturallanguageprocessingspecialization": "natural language processing specialization.jpg",
    "promptengineeringforchatgpt": "Prompt Engineering for ChatGPT.jpg",
    "ethicsofai": "ethics of ai.jpg",
    "vibecodingaidrivensoftwaredevelopment": "vibe coding Ai driven software development.jpg",
    "aiproductmanagement": "Ai product management_.jpg",
    "appliedgenerativeaillmengineering": "Applied Generative AI & LLM Engineering.jpg",
    "aiagentsautonomoussystemsdevelopment": "AI Agents & Autonomous Systems Development.jpg",
    "computervisionwithdeeplearning": "Computer Vision with Deep Learning.jpg",
    "aiforhealthcaremedicalimaging": "AI for Healthcare & Medical Imaging.jpg",
    "multimodalsystems": "Multimodal AI Systems.jpg",
    "edgeaitinyml": "Edge AI & TinyML.jpg",
    "airesearchpaperimplementation": "AI Research & Paper Implementation.jpg",
    "cs50introductiontocomputerscience": "CS50 introduction to computer science.jpg",
    "webdeveloperbootcamp": "web developer bootcamp.jpg",
    "cs50cybersecurity": "CS50 cybersecurity.jpg",
    "100dayspythonbootcamp": "100 days python bootcamp.jpg",
    "googleitsupportcertificate": "google it support certificate.jpg",
    "javaprogrammingfundamentals": "java programming fundamentals.jpg",
    "automatetheboringstuff": "automate the boring stuff.jpg",
    "awscloudpractitioner": "AWS Cloud Practitioner.jpg",
    "fullstackmerndevelopment": "Full Stack MERN Development.jpg",
    "kubernetescontainers": "Kubernetes & Containers.jpg",
    "advancedcybersecurityethicalhacking": "Advanced Cybersecurity & Ethical Hacking.jpg",
    "cloudengineeringawsazure": "Cloud Engineering (AWS + Azure).jpg",
    "systemdesignforscalableapps": "System Design for Scalable Apps.jpg",
    "linuxadministration": "Linux Administration.jpg",
    "apidevelopmentrestgraphql": "API Development (REST + GraphQL).jpg",
    "googledataanalytics": "google data analytics.jpg",
    "datasciencespecialization": "Data science specialization.jpg",
    "ibmdatasciencecertificate": "IBM data science certificate.jpg",
    "sqlfordatascience": "SQL for data science.jpg",
    "tableauspecialist": "tableau specialist.jpg",
    "statisticswithr": "statistics with R.jpg",
    "excelskillsforbusiness": "excel skills for business.jpg",
    "businessanalytics": "business analytics.jpg",
    "advancedmachinelearning": "advanced machine learning.jpg",
    "dataengineeringpythonspark": "data engineering ( python+ spark).jpg",
    "bigdataanalytics": "big data analytics.jpg",
    "timeseriesforecasting": "time series forecasting.jpg",
    "datascienceforfinance": "data science for finance.jpg",
    "abtesting": "AB testing.jpg",
    "deeplearningfordatascience": "deep learning for data science.jpg",
    "datascienceportfolioprojects": "data science portfolio projects.jpg",
    "datascienceinterviewprep": "data science interview prep.jpg",
    "theartsofvisualizingdata": "The Arts of Visualizing Data.jpg",
    "uxresearchpsychology": "UX Research & Psychology.png",
    "graphicdesignbranding": "Graphic design & branding.jpg",
    "webdesignuitrends": "web design ui trends.jpg",
    "mobileappdesign": "Mobile app design.jpg",
    "motiongraphics": "Motion graphics.jpg",
    "designsystems": "Design systems.jpg",
    "canvadesignmastery": "Canva design mastery.jpg",
    "3ddesignbasics": "3D design basics.png",
    "advanceduiprototyping": "advanced ui prototyping.jpg",
    "brandingstrategymasterclass": "branding strategy masterclass.jpg",
    "businessstrategy": "Business strategy.jpg",
    "digitalproductmanagement": "Digital product management.jpg",
    "successfulnegotiation": "Successful negotiation.jpg",
    "supplychainmanagement": "supply chain management.jpg",
    "leadingteams": "Leading teams.jpg",
    "startupfinance": "Startup finance.jpg",
    "corporatefinance": "corporate finance.jpg",
    "businessleadership": "Business leadership.jpg",
    "operationsmanagement": "Operations management.jpg",
    "strategicmanagement": "Strategic management.jpg",
    "internationalbusiness": "International business.jpg",
    "businesslaw": "Business law.jpg",
    "financialmodeling": "Financial modeling.jpg",
    "reinforcementlearningfrombasicstorobotics": "reinforcement learning basics to robotics.jpg",
    "mlopsdeployingaimodels": "MLops developing ai models.jpg",
    "pythonforeverybody": "python for everyone.jpg",
    "javascriptcourse": "javascript.jpg",
    "devopsengineeringcicd": "devops engeneering.jpg",
    "advanceddatavisualization": "avanced data visualization.jpg",
    "uiuxdesignfigma": "UI & UX design.jpg",
    "executivecommunication": "excutive communication.jpg",
    "mbaessentials": "MBS essentials.jpg",
    "aifinancequanttrading": "Ai in finance.jpg",
    "powerbianalyst": "power bi anyalyst.jpg"
};

const getCourseImage = (title: string) => {
    const normalized = title.toLowerCase().replace(/[^a-z0-9]/g, '').trim();
    return COURSE_IMAGE_MAPPING[normalized] ? `/Coursesimages/${COURSE_IMAGE_MAPPING[normalized]}` : "";
};
...
const generateCourse = (subject: string, hook: string, outcomes: string[], category: string, level: string, seedIndex: number) => {
    ...
    return {
        ...
        level: level,
        language: "English",
        thumbnail_url: getCourseImage(subject),
        status: "published",
        outcomes: outcomes,
...
const generateSpecificCourse = (
    ...
    return {
        ...
        language: "English",
        thumbnail_url: getCourseImage(title),
        status: "published",
