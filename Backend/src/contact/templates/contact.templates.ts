...
<body>
    <div class="container">
        <div style="text-align: center; padding: 25px 20px;">
            <img style="width: 200px;" src="https://nexverahub.com/assets/logo-B1jSTEFJ.PNG" alt="NEXVERAHUB"/>
...
<img style="width: 200px;" src="https://nexverahub.com/assets/logo-B1jSTEFJ.PNG" alt="NEXVERAHUB"/>
<p style="margin:8px 0 0 0;font-size:14px;color:#3b82f6">Empowering Learning Through Technology</p>
</td>
</tr>
...
<br><br>
© ${new Date().getFullYear()} Nexvera Hub. All rights reserved.
</td>
</tr>
...
<!-- Footer -->
<tr>
<td style="background:#f9fafb; padding:25px 40px; text-align:center;">
