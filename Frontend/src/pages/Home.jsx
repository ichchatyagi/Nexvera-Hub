...
import heroImage from '../assets/home-hero-v3.png';
                ...
                <div className="container mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-20">
                    <div className="flex-1 z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            ...
                            <Link to="/about" className="bg-white border border-slate-200 text-slate-900 font-black text-xs uppercase tracking-widest px-14 py-6 rounded-2xl hover:bg-slate-50 transition-all text-center">
                                Our Mission
                            </Link>
                        </div>
                    </div>
            ...
            <section className="py-20 lg:py-32">
                <div className="container mx-auto px-6 lg:px-12">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                        ...
                        <Link to="/course" className="flex flex-col items-center justify-center gap-4 px-6 py-10 rounded-[2.5rem] font-black text-[10px] uppercase tracking-[0.2em] bg-slate-950 text-white hover:bg-black transition-all">
