...
const GuideCard = ({ slug, title, description, time, category, color, metallicGlow, actionText = "Read Guide" }) => (
    ...
    >
        <Link to={`/guide/${slug}`} className={`bg-gradient-to-br ${color} p-8 rounded-[2.4rem] h-full flex flex-col items-start relative overflow-hidden flex-1`}>
            ...
            <h3 className="text-2xl font-black text-white mb-3 leading-tight leading-normal">{title}</h3>
    ...
    return (
        <div className="bg-transparent overflow-hidden">
                ...
                <div className="container mx-auto relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <motion.p
                            ...
                            className="text-xl text-slate-600 font-medium leading-relaxed mb-12 max-w-2xl"
                        >
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
                        <div className="max-w-2xl">
                            <h2 className="text-4xl lg:text-5xl font-black text-slate-900 mb-4 font-bold tracking-tight uppercase">Featured Learning Resources</h2>
            ...
            <section className="py-16 lg:py-24 px-6 lg:px-12">
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Explore by <span className="text-blue-600">Specialization</span></h2>
            ...
            <section className="py-16 lg:py-24 px-6 lg:px-12 bg-blue-50/30">
                <div className="container mx-auto">
                    <div className="text-center mb-20 text-center">
                        <h2 className="text-4xl lg:text-5xl font-black text-slate-900 mb-6 font-bold tracking-tight uppercase">Most Popular Free Guides</h2>
                ...
                <div className="container mx-auto">
                    <div className="bg-white/40 backdrop-blur-xl border border-blue-50 p-12 lg:p-20 rounded-[4rem] shadow-2xl relative overflow-hidden">
                        ...
                        <div className="relative z-10 mb-16">
                            <h2 className="text-4xl font-black text-slate-900 mb-4 tracking-tight uppercase">Learning Resource Library</h2>
                            <p className="text-slate-500 font-medium">Quick reference docs and tutorials for fundamental concept mastery.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
                            {libraryItems.map((item, idx) => (
                                ...
                                >
                                    <Link to={`/guide/${item.slug}`} className="flex flex-col h-full">
                                        <div className="flex items-center gap-4 mb-6">
                                            ...
                                            <h4 className="text-lg font-black text-slate-800 group-hover:text-blue-600 transition-colors leading-tight">{item.title}</h4>
                                        </div>
                                        <p className="text-slate-500 text-sm font-medium mb-8 flex-1">{item.summary}</p>
                                        <div className="text-blue-600 font-black uppercase text-[10px] tracking-widest flex items-center gap-2 hover:gap-4 transition-all mt-auto">
            ...
            <section className="py-16 lg:py-24 px-6 lg:px-12 bg-slate-50/50">
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-black text-slate-900 mb-4 font-bold tracking-tight uppercase">Why Students Use Nexvera Hub Guides</h2>
                        <p className="text-slate-500 font-medium pb-2 uppercase tracking-widest text-xs">The ultimate value for your learning journey</p>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-6 max-w-6xl mx-auto">
                        {[
                            ...
                            { title: "Completely free learning resources", icon: Award, color: "from-fuchsia-600 to-pink-600" }
                        ].map((benefit, idx) => (
