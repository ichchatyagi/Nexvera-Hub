...
const CategoryCard = ({ icon: Icon, title, description, color, metallicGlow }) => (
    <motion.div
        ...
        className={`relative p-[2px] rounded-3xl bg-gradient-to-br ${metallicGlow || 'from-slate-400 via-white to-slate-400'} shadow-xl group overflow-hidden cursor-pointer`}
    >
    ...
    <div className="mb-4">
        ...
        >
            <div className="bg-white rounded-[0.9rem] overflow-hidden">
                ...
                >
                    <span className="text-slate-900 font-black text-lg pr-8">{question}</span>
                    ...
                    {isOpen && (
                        ...
                        >
                            <div className="px-6 pb-6 pt-0 border-t border-slate-100">
                                <div className={`h-1 w-12 bg-gradient-to-r ${color} rounded-full mb-4`}></div>
    ...
    >
        <div className={`bg-gradient-to-br ${color} p-8 rounded-[1.4rem] h-full relative overflow-hidden flex flex-col`}>
            ...
            <div className="flex items-start gap-4 mb-4 flex-grow">
                ...
                <h3 className="text-xl font-black text-white leading-tight">{question}</h3>
            </div>
            <Link to={`/faq/${slug}`} className="flex items-center gap-2 text-white/90 font-black text-xs uppercase tracking-widest hover:text-white transition-all mt-auto w-fit">
        ...
        <div className="bg-transparent overflow-hidden">
            ...
            <section className="relative pt-32 lg:pt-40 pb-20 px-6 lg:px-12 overflow-hidden text-center">
                ...
                <div className="container mx-auto relative z-10 max-w-4xl">
                    ...
                    >
                        <Link to="/course" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-black px-10 py-5 rounded-2xl shadow-2xl shadow-blue-500/20 transition-all active:scale-95 flex items-center gap-3 uppercase tracking-widest text-sm">
                            Browse Courses
            ...
            <section className="py-20 px-6 lg:px-12">
                <div className="container mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <PopularQuestionCard question="Do I get certification after course completion?" color="from-emerald-500 to-teal-600" slug="certification-details" />
            ...
            <section className="py-16 lg:py-24 px-6 lg:px-12">
                <div className="container mx-auto max-w-4xl">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-black text-slate-900 mb-4 font-bold tracking-tight uppercase">Detailed Answers</h2>
                        <p className="text-slate-500 font-medium uppercase tracking-widest text-xs">Everything you need to know about your journey</p>
                    </div>
