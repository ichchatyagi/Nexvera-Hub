...
const JourneyStep = ({ step, title, description, color, index }) => (
    ...
    >
        <div className="flex flex-col items-center text-center">
            ...
            <h4 className="text-lg font-black text-slate-900 mb-2 px-2">{title}</h4>
        ...
        <div className="bg-transparent overflow-hidden">
            ...
            <section className="relative pt-32 lg:pt-40 pb-24 px-6 lg:px-12 overflow-hidden">
                ...
                <div className="container mx-auto relative z-10 text-center max-w-4xl">
                    ...
                    >
                        <button className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-black px-10 py-5 rounded-2xl shadow-2xl shadow-blue-500/20 transition-all active:scale-95 flex items-center gap-3 mx-auto">
                            Start Your Journey
            ...
            <section className="py-16 lg:py-24 bg-slate-50/50">
                <div className="container mx-auto px-6 lg:px-12 mb-12 text-center">
                    <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Our <span className="text-blue-600">Global Achievers</span></h2>
            ...
            <section className="py-16 lg:py-24 bg-blue-50/30">
                <div className="container mx-auto px-6 lg:px-12 mb-12 text-center">
                    <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">What Our <span className="text-blue-600">Learners Say</span></h2>
            ...
            {/* Stats Section */}
            <section className="py-16 lg:py-24 px-6 lg:px-12 text-center bg-white">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
                        {[
                            ...
                            <motion.div
                                ...
                                className="group"
                            >
                                <div className={`mb-4 mx-auto w-12 h-12 flex items-center justify-center ${stat.color} bg-slate-50 rounded-2xl group-hover:bg-white group-hover:shadow-xl transition-all duration-300`}>
                                    <stat.icon className="w-6 h-6" />
                                </div>
                                <h4 className="text-5xl font-black text-slate-900 mb-2 drop-shadow-sm">
                ...
                <div className="container mx-auto">
                    <div className="bg-white/40 backdrop-blur-xl border border-blue-50 p-12 lg:p-20 rounded-[4rem] relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10 text-center mb-16">
                            <h2 className="text-4xl lg:text-5xl font-black text-slate-900 mb-6 font-bold tracking-tight">Student <span className="text-blue-600">Wall of Fame</span></h2>
            ...
            <section className="py-16 lg:py-24 px-6 lg:px-12">
                <div className="container mx-auto">
                    <div className="flex items-end justify-between mb-16">
                        <div>
                            <h2 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">Student <span className="text-blue-600">Project Showcase</span></h2>
                            <p className="text-slate-500 font-medium">Real world applications built by our students</p>
                        </div>
                        <button className="hidden sm:flex items-center gap-2 text-blue-600 font-black uppercase tracking-widest text-sm hover:gap-4 transition-all">
            ...
            <section className="py-16 lg:py-24 px-6 lg:px-12 bg-white/50 backdrop-blur-sm">
                <div className="container mx-auto">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl font-black text-slate-900 mb-4 font-bold tracking-tight">The Student Journey</h2>
                    ...
                    <div className="relative p-10 lg:p-14 bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 rounded-[2.5rem] overflow-hidden group shadow-2xl">
                        ...
                        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button className="px-8 py-4 bg-white text-indigo-600 font-black rounded-xl shadow-xl hover:bg-slate-50 transition-all active:scale-95 text-xs uppercase tracking-widest whitespace-nowrap">
                                    Browse Courses
                                </button>
                                <button className="px-8 py-4 bg-cyan-400 text-slate-900 font-black rounded-xl shadow-xl hover:bg-cyan-300 transition-all active:scale-95 text-xs uppercase tracking-widest whitespace-nowrap">
                                    Join Now
                                </button>
                            </div>
                        </div>
