        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-white p-6">
                <div className="text-center">
                    ...
                    <Link to="/free-guides" className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 transition-all">
            ...
            <section className={`relative pt-32 lg:pt-40 pb-24 px-6 lg:px-12 bg-gradient-to-br ${guide.color} overflow-hidden`}>
                ...
                <div className="container mx-auto relative z-10">
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <Link to="/free-guides" className="inline-flex items-center gap-2 text-white/80 hover:text-white font-black uppercase tracking-widest text-xs transition-colors group">
                    ...
                    <div className="max-w-4xl">
                        ...
                        >
                            <div className="flex items-center gap-2 text-white font-bold bg-black/10 px-4 py-2 rounded-xl backdrop-blur-md">
                            ...
                            >
                                ...
                                {guide.content.map((section, idx) => (
                                    <div key={idx} className="mb-16 last:mb-0 group">
                                        <div className="flex items-center gap-4 mb-6">
                                            ...
                                            <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight m-0">{section.title}</h2>
                                        </div>
                                ...
                                <div className="mt-24 p-12 bg-slate-50 rounded-[3rem] border border-slate-100">
                                    <div className="flex items-center gap-4 mb-8">
                                        ...
                                        <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tight m-0">Recommended Resources</h3>
                                    </div>
                        ...
                        <div className="lg:w-1/3">
                            <div className="sticky top-40 space-y-10">
                                ...
                                <div className="p-10 rounded-[3rem] bg-slate-900 text-white relative overflow-hidden group shadow-2xl">
                                    ...
                                    <Link to="/course" className="w-full py-5 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-2xl transition-all relative z-10 flex items-center justify-center gap-3 uppercase tracking-widest text-xs">
                    ...
                    <div className="bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 rounded-[3rem] p-12 lg:p-20 overflow-hidden relative group text-center lg:text-left shadow-2xl">
                        ...
                        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link to="/free-guides" className="px-10 py-5 bg-white text-blue-600 font-black rounded-2xl shadow-xl hover:bg-slate-50 transition-all active:scale-95 text-xs uppercase tracking-widest">
                                    Browse All Guides
                                </Link>
