...
const LearningRoadmaps = () => {
    ...
    return (
        <div className="bg-transparent overflow-hidden">
            {/* Hero Section */}
            <section className="relative pt-32 lg:pt-40 pb-20 px-6 lg:px-12 overflow-hidden">
                ...
                <div className="container mx-auto relative z-10 max-w-4xl text-center">
                    ...
                    >
                        Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Educational</span> Roadmap
                    </motion.h1>
                    ...
                    >
                        <Link to="/course" className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-black px-10 py-5 rounded-2xl shadow-2xl hover:shadow-blue-500/30 transition-all flex items-center gap-3 uppercase tracking-widest text-sm">
                            Join the Journey
            ...
            <section className="py-16 lg:py-24 px-6 lg:px-12 bg-slate-50/50">
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">The <span className="text-blue-600">Nexvera</span> Advantage</h2>
            ...
            <section className="py-20 lg:py-32 px-6 lg:px-12">
                <div className="container mx-auto max-w-5xl">
                    <div className="text-center mb-24 relative">
                        ...
                        <span className="bg-white px-8 text-4xl lg:text-5xl font-black text-slate-900 inline-block uppercase tracking-tight">
                        ...
                        <div className="bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 rounded-[2.4rem] p-12 lg:p-14 overflow-hidden relative group">
                            ...
                            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 text-center lg:text-left">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                                    <Link to="/contact" className="px-10 py-5 bg-white text-indigo-600 font-black rounded-xl shadow-xl hover:bg-slate-50 transition-all active:scale-95 text-xs uppercase tracking-widest whitespace-nowrap flex items-center justify-center gap-3">
                                        Contact Support
                                        <ArrowRight className="w-5 h-5" />
                                    </Link>
                                    <Link to="/course" className="px-10 py-5 bg-cyan-400 text-slate-900 font-black rounded-xl shadow-xl hover:bg-cyan-300 transition-all active:scale-95 text-xs uppercase tracking-widest whitespace-nowrap flex items-center justify-center gap-3">
                                        Explore Courses
