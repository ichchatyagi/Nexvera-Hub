        ...
        >
            <div className="bg-white rounded-[2.4rem] h-full flex flex-col overflow-hidden relative">
                ...
                <div className="p-8 flex flex-col flex-1">
                    ...
                    <h3 className="text-2xl font-black text-slate-900 mb-4 leading-tight group-hover:text-blue-600 transition-colors tracking-tight">
                        {post.title}
                    </h3>
                ...
                <div className="container mx-auto relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            >
                                <Link href="/courses" className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-black px-6 lg:px-12 py-5 rounded-2xl shadow-2xl hover:shadow-blue-500/30 transition-all flex items-center justify-center gap-3 uppercase tracking-widest text-sm">
                                    Explore Courses
                        ...
                        <div className="bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 rounded-[2.4rem] p-10 lg:p-14 overflow-hidden relative group">
                            ...
                            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 text-center lg:text-left">
                                <div className="max-w-xl">
                                    ...
                                    <h2 className="text-3xl lg:text-4xl font-black text-white leading-tight uppercase tracking-tight mb-4 tracking-tighter">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                                    <Link href="/courses" className="px-8 py-4 bg-white text-blue-600 font-black rounded-xl shadow-lg hover:bg-blue-50 transition-all active:scale-95 text-[10px] uppercase tracking-widest whitespace-nowrap flex items-center justify-center gap-2">
                                        Browse Courses
                                        <ArrowRight className="w-4 h-4" />
                                    </Link>
                                    <Link href="/roadmaps" className="px-8 py-4 bg-cyan-400 text-slate-900 font-black rounded-xl shadow-lg hover:bg-cyan-300 transition-all active:scale-95 text-[10px] uppercase tracking-widest whitespace-nowrap flex items-center justify-center gap-2">
                                        View Roadmaps
