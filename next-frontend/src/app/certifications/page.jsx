                    ...
                    <div className="flex-1 w-full max-w-xl order-1 lg:order-2">
                        ...
                        >
                            ...
                            <div className="relative z-10 p-8 border border-white/10 flex flex-col items-center text-center">
                                ...
                                <p className="text-cyan-400 text-sm font-black uppercase tracking-widest leading-normal">Professional Specialization</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
                                    ...
                                    <div className="bg-white/95 backdrop-blur-md p-8 rounded-[2.4rem] h-full flex flex-col">
                                        <div className="flex items-center gap-4 mb-6">
                                            ...
                                            <div>
                                                ...
                                                <span className={`text-[9px] font-bold px-2 py-0.5 rounded-md bg-gradient-to-r ${student.color} text-white uppercase tracking-widest leading-loose`}>{student.cert}</span>
                                            </div>
                                        </div>
