...
const FeatureCard = ({ icon: Icon, title, description, index, colorClass }) => (
    ...
    >
        ...
        <h3 className="text-xl font-black text-slate-900 mb-3 tracking-tight uppercase leading-none">{title}</h3>
        <p className="text-slate-800 font-medium leading-relaxed text-sm">{description}</p>
    </motion.div>
);
...
const StepCard = ({ number, title, description, index, colorClass }) => (
    ...
    >
        ...
        <div>
            <h4 className="text-2xl font-black text-slate-900 mb-2 tracking-tight uppercase">{title}</h4>
            <p className="text-slate-800 font-bold leading-snug text-sm">{description}</p>
        </div>
    </motion.div>
);
...
const CareerSupport = () => {
    ...
    const benefits = [
        { name: "Practical Learning", color: "bg-blue-600", light: "bg-blue-50" },
        { name: "Real-World Projects", color: "bg-cyan-600", light: "bg-cyan-50" },
        { name: "Career Mentorship", color: "bg-purple-600", light: "bg-purple-50" },
        { name: "Job Prep Support", color: "bg-indigo-600", light: "bg-indigo-50" },
        { name: "Internship Certification", color: "bg-amber-600", light: "bg-amber-50" },
        { name: "Skill-Based Training", color: "bg-rose-600", light: "bg-rose-50" }
    ];
        ...
        <div className="min-h-screen bg-transparent">
                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        <div className="lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 text-blue-700 font-semibold text-sm mb-6 uppercase tracking-widest text-[10px] font-black">
            ...
            <section className="py-20 bg-white/30 backdrop-blur-sm border-y border-blue-100/50">
                <div className="container mx-auto px-6 lg:px-12 text-center">
                    ...
                    >
                        <h2 className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight uppercase">Built for the Professional World</h2>
                        <p className="text-xl text-slate-600 leading-relaxed font-sm font-medium">
            ...
            <section className="py-16 lg:py-24">
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="mb-16 text-center max-w-2xl mx-auto text-center">
                        <h2 className="text-4xl font-black text-slate-900 mb-4 tracking-tight uppercase">Everything You Need to Succeed</h2>
                        <p className="text-slate-600 font-medium">Comprehensive support at every stage of your career journey.</p>
                    </div>
                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        <div className="lg:w-1/3 text-center lg:text-left">
                            <h2 className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight uppercase">Our 4-Step Career Preparation Process</h2>
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-[3rem] p-8 lg:p-12 border border-amber-100 flex flex-col lg:flex-row items-center gap-10">
                        <div className="lg:w-1/2">
                            ...
                            <h2 className="text-3xl font-black text-slate-900 mb-4 tracking-tight uppercase">Industry-Recognized Certification</h2>
                            ...
                            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {['Verified Skills', 'Project Authenticated', 'Industry Recognition'].map((item, i) => (
                                    <li key={i} className="flex items-center gap-3 font-black text-slate-800 text-xs uppercase tracking-tight">
            ...
            <section className="py-20 bg-teal-50/30">
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="text-center mb-12 text-center">
                        <h2 className="text-3xl font-black text-slate-900 mb-3 tracking-tight uppercase">Why Students Choose Nexvera Hub</h2>
                        <p className="text-slate-600 font-bold uppercase tracking-widest text-[10px] block opacity-60">Excellence in education and career development</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {benefits.map((benefit, index) => (
                            <motion.div
                                ...
                                className={`p-6 rounded-2xl flex items-center gap-4 group hover:bg-white transition-all duration-300 border border-transparent hover:border-blue-100 shadow-sm hover:shadow-xl ${benefit.light}`}
                            >
                                ...
                                <span className="text-lg font-black tracking-tight text-slate-800 uppercase text-xs">{benefit.name}</span>
                            </motion.div>
                        ))}
                    </div>
                </div>
