...
const categoryStyles = {
    ...
    'Business & Management': { colors: ['#FB923C', '#F97316', '#EA580C'], glow: 'rgba(249, 115, 22, 0.3)' },
    'Entrepreneurship': { colors: ['#22D3EE', '#06B6D4', '#0891B2'], glow: 'rgba(6, 182, 212, 0.3)' },
    'Project Management': { colors: ['#6366F1', '#4F46E5', '#4338CA'], glow: 'rgba(79, 70, 229, 0.3)' },
    'Personal Development': { colors: ['#EC4899', '#D946EF', '#C026D3'], glow: 'rgba(217, 70, 239, 0.3)' },
